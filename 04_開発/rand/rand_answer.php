            ...
            <?php
               ...
               ?>
                <form action="./rand.php" method="post">
                    <button class="btn btn-secondary offset-1 col-4" type="button" onclick="location.href='../home/home.php'">ホームへ</button>
                    <button class="btn btn-primary offset-2 col-4" type="submit">次へ</button>
                </form>
            </div>
    <?php
        break;
